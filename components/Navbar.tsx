        ...
        <div className="wrapper navbar-height py-4 flex justify-between items-center">
           <div className="flex gap-0.5 items-center">
            ...
            <div className="flex gap-7.5 items-center">  
                <Link href="/plan-trip" className="px-5 py-2 rounded-full bg-gradient-to-r from-[#2A9D8F] to-[#1A6B4A] text-white font-semibold text-sm hover:opacity-90 hover:shadow-lg hover:shadow-[#1A6B4A]/40 transition-all duration-200">
                    {PlanTrip("planTrip")}
                </Link>
